			...
			<div class="api_modal_content">
				...
				<div class="api_form">
								...
								<? if($FIELD == 'RATING'): ?>
									<div class="api-form-rating">
										<div class="api-star-rating">
											<i class="api-icon-star active" data-label="<?=$arParams['MESS_STAR_RATING_1']?>"><span class="count pink">1</span></i>
											...
											<i class="api-icon-star active" data-label="<?=$arParams['MESS_STAR_RATING_4']?>"><span class="count orange">4</span></i>
											<i class="api-icon-star active" data-label="<?=$arParams['MESS_STAR_RATING_5']?>"><span class="count green">5</span></i>
					...
					<div class="api_row api_buttons text-center">
						<button class="review-custom-btn">
	...
	<script type="text/javascript">
		jQuery(document).ready(function ($) {
            ...
            $('.api_modal_close').click(function () {
                ...
                $('#<?=$modalId?> .api_modal_dialog').css('opacity','0');
