    ...
    <div class="personal-cabinet-content__my-profile__info">
        ...
        <?endif?>
            <div style="margin-top: 20px">
                <input style="margin-left: 0;" class="save" type="submit" name="send_account_info" value="<?=GetMessage("AUTH_SEND")?>" />
            </div>
            <div style="margin-top: 16px">
                <p><a style="color:#9DD4B3;" href="<?=$arResult["AUTH_AUTH_URL"]?>"><b><?=GetMessage("AUTH_AUTH")?></b></a></p>
            </div>
        </form>
