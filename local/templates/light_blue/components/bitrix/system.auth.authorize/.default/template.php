...
<div class="personal-cabinet-content__my-profile personal-cabinet-content-auth">
    <div class="personal-cabinet-content__my-profile__info">
        <div class="personal-cabinet-content__my-profile__info-form">
            <div class="bx-auth">
                <div class="auth-popup__header text-center">Вход в личный кабинет</div>
                <div class="bx-auth-note" style="text-align: center;"><?=GetMessage("AUTH_PLEASE_AUTH")?><?
...
<!--                                <td><input type="checkbox" id="USER_REMEMBER" name="USER_REMEMBER" value="Y" /><label for="USER_REMEMBER">&nbsp;--><?//=GetMessage("AUTH_REMEMBER_ME")?><!--</label></td>-->
                                <td class="checkbox-group">
                                    <label data-role="label_GUEST_PARKING" class="bx_filter_param_label " for="USER_REMEMBER">
                                        <span class="bx_filter_input_checkbox">
                                            <input type="checkbox" id="USER_REMEMBER" name="USER_REMEMBER" value="Y">
                                                <div class="checkbox"><img src="/local/templates/light_blue/assets/images/checkbox.svg" alt=""></div>
                                            <span class="bx_filter_param_text"><?=GetMessage("AUTH_REMEMBER_ME")?></span>
                                        </span>
                                    </label>
                                </td>
                            </tr>
                        ...
                        <tr>
                            <td></td>
                            <td class="authorize-submit-cell"><input type="submit" class="btn btn-primary save" name="Login" value="<?=GetMessage("AUTH_AUTHORIZE")?>" /></td>
                        </tr>
                        <tr>
                            <td></td>
                            <td>
                                <?if ($arParams["NOT_SHOW_LINKS"] != "Y"):?>
                                    <noindex>
                                        <p>
                                            <a style="color: #9DD4B3;" href="<?=$arResult["AUTH_FORGOT_PASSWORD_URL"]?>" rel="nofollow"><?=GetMessage("AUTH_FORGOT_PASSWORD_2")?></a>
                                        </p>
                                    </noindex>
                                <?endif?>
                            </td>
                        ...
                        <tr>
                            ...
                            <td>
                                <?if($arParams["NOT_SHOW_LINKS"] != "Y" && $arResult["NEW_USER_REGISTRATION"] == "Y" && $arParams["AUTHORIZE_REGISTRATION"] != "Y"):?>
                                    <noindex>
                                        <p>
                                            <a style="color: #9DD4B3;" href="<?=$arResult["AUTH_REGISTER_URL"]?>" rel="nofollow"><?=GetMessage("AUTH_REGISTER")?></a><br />
                                        </p>
                                    </noindex>
                                <?endif?>
                            </td>
