                            ...
                            <div class="bx_filter_parameters_box_container">
                                ...
                                <div class="bx_ui_slider_track" id="drag_track_<?= $key ?>">
                                    ...
                                    $price2 = $arItem["VALUES"]["MIN"]["VALUE"] +
                                        round(($arItem["VALUES"]["MAX"]["VALUE"] - $arItem["VALUES"]["MIN"]["VALUE"]) /
                                            4);
                        ...
                        <div class="bx_filter_parameters_box_container checkboxes">
                            ...
                            case "A"://NUMBERS_WITH_SLIDER
                                ...
                                <div class="bx_ui_slider_track" id="drag_track_<?= $key ?>">
                                    ...
                                    $value2 = $arItem["VALUES"]["MIN"]["VALUE"] +
                                        round(($arItem["VALUES"]["MAX"]["VALUE"] - $arItem["VALUES"]["MIN"]["VALUE"]) /
                                            4);
                                    $value3 = $arItem["VALUES"]["MIN"]["VALUE"] +
                                        round(($arItem["VALUES"]["MAX"]["VALUE"] - $arItem["VALUES"]["MIN"]["VALUE"]) /
                                            2);
                                    $value4 = $arItem["VALUES"]["MIN"]["VALUE"] +
                                        round((($arItem["VALUES"]["MAX"]["VALUE"] - $arItem["VALUES"]["MIN"]["VALUE"]) *
                                                3) / 4);
                                            ...
                                            <ul>
                                                <li>
                                                    <label for="<?= "all_" . $arCur["CONTROL_ID"] ?>"
                                                           ...
                                                           onclick="smartFilter.selectDropDownItem(this, '<?= CUtil::JSEscape("all_" .
                                                               $arCur["CONTROL_ID"]) ?>')">
                                                        <? echo GetMessage("CT_BCSF_FILTER_ALL"); ?>
                                                    </label>
                                                </li>
                                    ...
                                    <div class="bx_filter_input_container bx_filter_calendar_container">
                                        <? $APPLICATION->IncludeComponent(
                                            ...
                                            array(
                                                ...
                                                'SHOW_INPUT' => 'Y',
                                                'INPUT_ADDITIONAL_ATTR' => 'class="calendar" placeholder="' .
                                                    FormatDate("SHORT", $arItem["VALUES"]["MIN"]["VALUE"]) .
                                    ...
                                    <div class="bx_filter_input_container bx_filter_calendar_container">
                                        <? $APPLICATION->IncludeComponent(
                                            ...
                                            array(
                                                ...
                                                'SHOW_INPUT' => 'Y',
                                                'INPUT_ADDITIONAL_ATTR' => 'class="calendar" placeholder="' .
                                                    FormatDate("SHORT", $arItem["VALUES"]["MAX"]["VALUE"]) .
                                                    '" onkeyup="smartFilter.keyup(this)" onchange="smartFilter.keyup(this)"',
                    ...
                    <div class="bx_filter_parameters_box_container">
                        ...
                        <div class="bx_filter_popup_result left"
                            ...
                            <? echo GetMessage("CT_BCSF_FILTER_COUNT",
                                array("#ELEMENT_COUNT#" => '<span id="modef_num">' .
                                    intval($arResult["ELEMENT_COUNT"]) . '</span>')); ?>
