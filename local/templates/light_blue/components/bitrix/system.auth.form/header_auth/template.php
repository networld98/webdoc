...
<form name="system_auth_form<?=$arResult["RND"]?>" method="post" target="_top" action="<?if($_SERVER["SERVER_NAME"]==="webdoc.clinic"){?>/lc/<?}else{?>https://webdoc.clinic/lc/<?}?>">
<?if($arResult["BACKURL"] <> ''):?>
	<input type="hidden" name="backurl" value="<?if($_SERVER["SERVER_NAME"]==="webdoc.clinic"){?>/lc/<?}else{?>https://webdoc.clinic/lc/<?}?>" />
<?endif?>
...
<form action="<?if($_SERVER["SERVER_NAME"]==="webdoc.clinic"){?>/lc/<?}else{?>https://webdoc.clinic/lc/<?}?>">
	<table width="95%">
		<tr>
			<td align="center">
