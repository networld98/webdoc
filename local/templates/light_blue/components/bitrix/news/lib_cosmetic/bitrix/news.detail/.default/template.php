    ...
    <div class="row">
        ...
        <div class="col-lg-9">
            ...
            <div class="illness-doctor-block">
                <?
                $doctor_spec = $arResult['PROPERTIES']['DOCTORS_SPEC']['VALUE'];
                $clinic_spec = $arResult['PROPERTIES']['CLINICS_SPEC']['VALUE'];
                ?>
                <div class="illness-doctor-list-block">
                    <?if (strpos($doctorName, 'Болезнь') !== 0 && strpos($doctorName, 'Синдром') !== 0 ) {?>
                ...
                <div class="illness-clinic-list-block">
