                            ...
                            <div>
                                ...
                                <ul class="doctors-list-item__days-list">
                                    <?foreach($daterange as $date){?>
                                        ...
                                        <li class="select-doctor-day_<?=$arItem['ID']?> doctors-list-item__days-list-item <?if (!in_array($days[$date->format("N")],$day)){?>pass<?}elseif (in_array($days[$date->format("N")],$day) && $date->format("Ymd") == date('Ymd')){?>active<?}?>" data-day="<?=date($days[$date->format("N")])?>" data-doctor="<?=$arItem['ID']?>"><?= date( $days[$date->format("N")]);?>, <?= date($date->format("d"));?></li>
                                    <?}?>
                                </ul>
