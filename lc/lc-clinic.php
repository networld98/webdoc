            ...
            <div class="personal-cabinet-content__my-profile__info-form">
                ...
                <ul>
                    <li>
                        ...
                        <p> <label class="photoFile-label">Изменить логотип<input type="file" class="photoFile" style="display: block!important;" name="DETAIL_PICTURE" value="">
                            </label>
                        </p>
                    </li>
                    <li>
            ...
            <div class="personal-cabinet-content__my-profile__services-col">
                ...
                <ul>
                    ...
                    while($ob = $res->GetNextElement()){
                        $arFields = $ob->GetFields(); ?>
                        <li>
                            <input type="checkbox" <?if(in_array($arFields['ID'],$arProps['SPECIALIZATION']['VALUE'])){?>checked<?}?> value="<?=$arFields['ID']?>" name="<?=$arProps['SPECIALIZATION']['CODE']?>_<?=$arFields['ID']?>" id="<?=$arFields['ID']?>">
