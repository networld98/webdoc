...
$APPLICATION->SetTitle("деталка-болезни");
?>

<section class="container illness-detail">
    <h1 class="title-h2">Сколиоз позвоночника</h1>
    <div class="row">
        <div class="col-lg-3">
            <div class="anchor-block fixed-block">
                <ul class="anchor-block-list">
                    <li><a href=".to-preview" class="flowing-scroll">Обзор болезни</a></li>
                    <li><a href=".to-symptoms" class="flowing-scroll">Симптомы сколиоза</a></li>
                    <li><a href=".to-choice" class="flowing-scroll" data-href="to-choice">К какому врачу обратиться при сколиозе позвоночника?</a></li>
                </ul>
            </div>
        </div>
        <div class="col-lg-9">
            <div class="illness-detail-block">  
                ...
                <p class="accent-text">Сколиоз — это противоестественное боковое искривление позвоночника.</p>
            ...
            <div class="illness-detail-block">
                <h3 class="title-h3 to-symptoms">Симптомы сколиоза</h3>
                <p>В детском возрасте сколиоз редко вызывает ощутимые симптомы. Единственной причиной для беспокойства становится видимое искривление формы спины. Как правило, только взрослые люди со сколиозом испытывают боль в спине.</p>
                <p>В детском возрасте сколиоз редко вызывает ощутимые симптомы. Единственной причиной для беспокойства становится видимое искривление формы спины. Как правило, только взрослые люди со сколиозом испытывают боль в спине.</p>
                <p>В детском возрасте сколиоз редко вызывает ощутимые симптомы. Единственной причиной для беспокойства становится видимое искривление формы спины. Как правило, только взрослые люди со сколиозом испытывают боль в спине.</p>
                <ul>
                    <li>церебральный паралич — состояние, вызванное повреждением головного мозга ребенка, которое происходит во время родов или сразу после этого;</li>
                    <li>церебральный паралич — состояние, вызванное повреждением головного <a href="#">мозга</a> ребенка, которое происходит во время родов или сразу после этого;</li>
                    <li>церебральный паралич — состояние, вызванное повреждением головного мозга ребенка, которое происходит во время родов или сразу после этого;</li>
                </ul>
                <p>В детском возрасте сколиоз редко вызывает ощутимые симптомы. Единственной причиной для беспокойства становится видимое искривление формы спины. Как правило, только взрослые люди со сколиозом испытывают боль в спине.</p>
                <p>В детском возрасте сколиоз редко вызывает ощутимые симптомы. Единственной причиной для беспокойства становится видимое искривление формы спины. Как правило, только взрослые люди со сколиозом испытывают боль в спине.</p>
                <p>В детском возрасте сколиоз редко вызывает ощутимые <a href="#">симптомы.</a> Единственной причиной для беспокойства становится видимое искривление формы спины. Как правило, только взрослые люди со сколиозом испытывают боль в спине.</p>
            </div>
            <div class="illness-detail-block">
