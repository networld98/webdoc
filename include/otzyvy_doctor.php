 <?$APPLICATION->IncludeComponent(
	...
	Array(
		...
		"FORM_FORM_SUBTITLE" => "",
		"FORM_FORM_TITLE" => "Отзыв о магазине DOC.BTX.BZ",
...
<p>Открыть на сайте #LINK#</p>",
		"FORM_MESS_ADD_REVIEW_EVENT_THEME" => "Отзыв о магазине DOC.BTX.BZ (оценка: #RATING#) ##ID#",
		...
		"FORM_SHOP_TEXT" => "Отзывы о магазине DOC.BTX.BZ",
		"FORM_USE_EULA" => "Y",
		"FORM_USE_PRIVACY" => "Y",
		"IBLOCK_ID" => "",
		"INCLUDE_CSS" => "Y",
...
К Вашему отзыву добавлен официальный ответ, для просмотра перейдите по ссылке #LINK#",
		...
		"LIST_SET_TITLE" => "N",
		"LIST_SHOP_NAME_REPLY" => "DOC.BTX.BZ",
		"LIST_SHOW_THUMBS" => "Y",
